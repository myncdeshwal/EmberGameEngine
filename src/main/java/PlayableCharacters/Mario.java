...
import static Util.TransitionDnD.generateSpriteObject;
...
public class Mario {
    ...
    public static GameObject generateMario() {
        ...
        GameObject mario = generateSpriteObject(playerSprites.getSprite(0), Settings.GRID_WIDTH, Settings.GRID_WIDTH);
        ...
        pb.width = Settings.GRID_WIDTH;
        pb.height = Settings.GRID_HEIGHT;
        ...
        mario.addComponent(new CircleCollider());
